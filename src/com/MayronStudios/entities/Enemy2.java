...
public class Enemy2 extends Entity {
	...
	public Enemy2(int x, int y, int width, int height, BufferedImage sprite) {
		...
		// Animações quantidade
				...
				for (int i = 0; i < 4; i++) {
					upEnemy[i] = Game.spritesheetEnemy.getSprite(48 + (i * 16), 64, 16, 16);
				}for (int i = 0; i < 4; i++) {
					downEnemy[i] = Game.spritesheetEnemy.getSprite(48 + (i * 16), 80, 16, 16);
				}for (int i = 0; i < 4; i++) {
					rightEnemy[i] = Game.spritesheetEnemy.getSprite(48 + (i * 16), 96, 16, 16);
				}for (int i = 0; i < 4; i++) {
					leftEnemy[i] = Game.spritesheetEnemy.getSprite(48 + (i * 16), 112, 16, 16);
				}
				
				for (int i = 0; i < 3; i++) {
					StopupEnemy[i] = Game.spritesheetEnemy.getSprite(0 + (i * 16), 64, 16, 16);
				}for (int i = 0; i < 3; i++) {
					StopdownEnemy[i] = Game.spritesheetEnemy.getSprite(0 + (i * 16), 80, 16, 16);
				}for (int i = 0; i < 3; i++) {
					StoprightEnemy[i] = Game.spritesheetEnemy.getSprite(0 + (i * 16), 96, 16, 16);
				}for (int i = 0; i < 3; i++) {
					StopleftEnemy[i] = Game.spritesheetEnemy.getSprite(0 + (i * 16), 112,16, 16);
				}
				
				for (int i = 0; i < 3; i++) {
					HitupEnemy[i] = Game.spritesheetEnemy.getSprite(112 + (i * 16), 64, 16, 16);
				}for (int i = 0; i < 3; i++) {
					HitdownEnemy[i] = Game.spritesheetEnemy.getSprite(112 + (i * 16), 80, 16, 16);
				}for (int i = 0; i < 3; i++) {
					HitrightEnemy[i] = Game.spritesheetEnemy.getSprite(112 + (i * 16), 96, 16, 16);
				}for (int i = 0; i < 3; i++) {
					HitleftEnemy[i] = Game.spritesheetEnemy.getSprite(112 + (i * 16), 112, 16, 16);
				}
				...
				for (int i = 0; i < 4; i++) {
					KillupEnemy[i] = Game.spritesheetEnemy.getSprite(160 + (i * 16), 64, 16, 16);
				}for (int i = 0; i < 4; i++) {
					KilldownEnemy[i] = Game.spritesheetEnemy.getSprite(160 + (i * 16), 80, 16, 16);
				}for (int i = 0; i < 4; i++) {
					KillrightEnemy[i] = Game.spritesheetEnemy.getSprite(160 + (i * 16), 96, 16, 16);
				}for (int i = 0; i < 4; i++) {
					KillleftEnemy[i] = Game.spritesheetEnemy.getSprite(160 + (i * 16), 112, 16, 16);
				}
				for (int i = 0; i < 1; i++) {
					Kill2upEnemy[i] = Game.spritesheetEnemy.getSprite(208 + (i * 16), 64, 16, 16);
				}for (int i = 0; i < 1; i++) {
					Kill2downEnemy[i] = Game.spritesheetEnemy.getSprite(208 + (i * 16), 80, 16, 16);
				}for (int i = 0; i < 1; i++) {
					Kill2rightEnemy[i] = Game.spritesheetEnemy.getSprite(208 + (i * 16), 96, 16, 16);
				}for (int i = 0; i < 1; i++) {
					Kill2leftEnemy[i] = Game.spritesheetEnemy.getSprite(208 + (i * 16), 1, 16, 16);
				}
				for (int i = 0; i < 2; i++) {
		...
		for(int i = 0; i < Game.entities.size(); i++) {
			...
			if(e instanceof EntityColision) {
				...
				if(EntityColision.isCollidding(this, e)) {
					if(down) {
					    y -= Game.inimigo2.speed;
					    down = false;
					} if(up) {
						y += Game.inimigo2.speed;
						up = false;
					}if(right) {
						x -= Game.inimigo2.speed;
						right = false;
					} if(left) {
						x += Game.inimigo2.speed;
						left = false;
